...
namespace TranXuanTruongBTH2.Controllers
{
    public class PersonController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,PersonID,Personname,Birthday")] Person person)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("ID,PersonID,Personname,Birthday")] Person person)
        {
            if (id != person.ID)
            {
                return NotFound();
